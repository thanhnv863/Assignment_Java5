...
<section class="bg-white py-8">
    ...
    <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
        ...
        <div style="margin: 20px">
            ...
            <a href="/mua-hang/${l.id}">
                <img width="350px" height="298px" src="/images/${l.anh}" alt="..." class="hover:grow hover:shadow-lg">
                <div style="text-align: center; margin-top: 20px; text-shadow: 5px 10px 10px red">
                    <p>${l.sanPham.ten}</p>
                </div>
                <div style="text-align: center; margin-top: 20px; font-weight: bold; text-decoration: none">
                    <p>${l.donGia}$</p>
                </div>
                <div style="text-align: center; margin-top: 20px">
                    <Button class="btn btn-outline-dark" type="submit">Xem Chi Tiết</Button>
                </div>
            </a>
        </div>
        </c:forEach>
